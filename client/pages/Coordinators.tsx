...
export default function Coordinators() {
  ...
  const filteredCoordinators = coordinators.filter(
    (coord) =>
      ...
      coord.specialties.some((specialty) =>
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-muted-foreground">
              Connect with your dedicated WME team members
            </p>
          </div>
          <Link to="/dashboard">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold">
                    {coordinators.filter((c) => c.status === "online").length}
                  </p>
                </div>
        ...
        <Tabs defaultValue="all" className="space-y-6">
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center gap-4">
                        <div className="relative">
                          ...
                          <div
                            className={`absolute -bottom-1 -right-1 w-4 h-4 ${getStatusColor(coordinator.status)} rounded-full border-2 border-background`}
                          />
                        </div>
                        <div>
                    ...
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-2">
                        <div
                          className={`w-2 h-2 ${getStatusColor(coordinator.status)} rounded-full`}
                        />
          ...
          <TabsContent value="music">
            <p className="text-muted-foreground">
              Music division coordinators will be displayed here.
            </p>
          </TabsContent>

          <TabsContent value="film">
            <p className="text-muted-foreground">
              Film & TV coordinators will be displayed here.
            </p>
          </TabsContent>

          <TabsContent value="digital">
            <p className="text-muted-foreground">
              Digital & brand partnership coordinators will be displayed here.
            </p>
          </TabsContent>
        </Tabs>
      </div>
