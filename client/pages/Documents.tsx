...
export default function Documents() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'Pending Signature': return 'bg-yellow-500/10 text-yellow-500 border-yellow-500/20';
  ...
  const pendingSignatures = documents.filter(doc => doc.status === 'Pending Signature').length;
  const completedDocs = documents.filter(doc => doc.status === 'Completed' || doc.status === 'Signed').length;
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-muted-foreground">Manage NDAs, contracts, and legal documents</p>
          </div>
        ...
        <Tabs defaultValue="all" className="space-y-6">
                  ...
                  {doc.status === 'Pending Signature' && doc.dueDate && (
                    <div className="mt-4 pt-4 border-t border-border">
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-sm text-muted-foreground">Due: {doc.dueDate}</span>
                        <span className="text-sm font-medium text-yellow-600">Action Required</span>
                      </div>
          ...
          <TabsContent value="pending">
            <div className="space-y-4">
              {filteredDocuments
                ...
                .map((doc) => (
                  <Card key={doc.id} className="border-yellow-200 bg-yellow-50/50 dark:bg-yellow-950/20">
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between">
          ...
          <TabsContent value="signed">
            <p className="text-muted-foreground">Signed documents will be displayed here.</p>
          </TabsContent>

          <TabsContent value="contracts">
            <p className="text-muted-foreground">Contract documents will be displayed here.</p>
          </TabsContent>

          <TabsContent value="ndas">
            <p className="text-muted-foreground">NDA documents will be displayed here.</p>
          </TabsContent>
        </Tabs>
      </div>
    </div>
