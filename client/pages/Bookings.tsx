      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-muted-foreground">Manage your talent bookings and track their progress</p>
          </div>
          <Link to="/dashboard">
        ...
        <Tabs defaultValue="all" className="space-y-6">
                ...
                <CardContent className="p-6">
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-muted-foreground mb-1">{booking.event}</p>
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center gap-4">
                      ...
                      <div className="lg:w-32">
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <span className="text-xs font-medium">{booking.timeline}%</span>
                        </div>
                  ...
                  <div className="mt-4 pt-4 border-t border-border">
                    <p className="text-sm text-muted-foreground">
                      Coordinator: <span className="font-medium text-foreground">{booking.coordinator}</span>
                    </p>
                  </div>
                </CardContent>
              </Card>
          ...
          <TabsContent value="active">
            <p className="text-muted-foreground">Active bookings will be displayed here.</p>
          </TabsContent>

          <TabsContent value="pending">
            <p className="text-muted-foreground">Pending bookings will be displayed here.</p>
          </TabsContent>
