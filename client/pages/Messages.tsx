  ...
  const conversations = [
    {
      ...
      avatar: 'SJ',
      lastMessage: 'The Taylor Swift contract is ready for your review. Please check the attached documents.',
      timestamp: '2 min ago',
      unread: 3,
      online: true,
      priority: 'high'
    ...
    },
    {
      ...
      avatar: 'DP',
      lastMessage: 'Please review the updated NDA terms at your earliest convenience.',
      timestamp: 'Yesterday',
      unread: 0,
      online: false,
      priority: 'high'
  ...
  const messages = {
    chat1: [
      ...
      },
      {
        id: 3,
        sender: 'Sarah Johnson',
        content: 'Perfect! I have some exciting updates about the Taylor Swift Grammy performance.',
        timestamp: '10:33 AM',
        isMe: false,
        status: 'read'
      },
      {
        id: 4,
        sender: 'Sarah Johnson',
        content: 'The contract is ready for your review. I\'ve attached all the necessary documents including the performance agreement and technical requirements.',
        timestamp: '10:35 AM',
        isMe: false,
        status: 'read',
        attachments: [
          { name: 'Taylor_Swift_Performance_Contract.pdf', size: '2.4 MB', type: 'pdf' },
      ...
      },
      {
        id: 5,
        sender: 'You',
        content: 'Thank you! I\'ll review these documents today and get back to you.',
        timestamp: '10:40 AM',
        isMe: true,
        status: 'delivered'
      },
      {
        id: 6,
        sender: 'Sarah Johnson',
        content: 'Sounds great! Please let me know if you have any questions. The deadline for signature is Friday.',
        timestamp: '2 min ago',
        isMe: false,
        status: 'unread'
      }
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-muted-foreground">Communicate with your WME coordinators and team</p>
          </div>
          <Link to="/dashboard">
              ...
              <>
                      ...
                      >
                        ...
                        >
                          ...
                          <div className={`flex items-center justify-between mt-2 text-xs ${
                            message.isMe ? 'text-black/70' : 'text-muted-foreground'
                          }`}>
                            ...
                            {message.isMe && (
                              <div className="flex items-center gap-1">
                                ...
                                {message.status === 'unread' && <Circle className="w-3 h-3" />}
                              </div>
                            )}
                          </div>
                        </div>
                ...
                <div className="p-4">
                  ...
                  <p className="text-xs text-muted-foreground mt-2">
                    Messages are encrypted and secure. Only you and WME coordinators can access this conversation.
                  </p>
                </div>
              </>
            ) : (
