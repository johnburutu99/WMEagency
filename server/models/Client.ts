...
export const ClientSchema = z.object({
  bookingId: z.string().regex(/^[A-Z0-9]{8}$/, 'Booking ID must be 8 alphanumeric characters'),
...
export const UpdateClientSchema = ClientSchema.partial().omit({ bookingId: true });
